...
def syllablesInWord(word):
    ...
    if len(word) > 5 and word[-5:] in ['tched'] or word[-4:] in ['shed', 'osed', 'ried', 'ened', 'ssed']:
        count -= 1
...
if __name__ == '__main__':
    for word in "He looked at me with suppressed eagerness as cambyses or csar".split():
